# cdm-spark-cluster-manager-api-client
A client library for accessing CDM Spark Cluster Manager API

> **⚠️ Important:** This model is auto-generated by [openapi-python-client](https://pypi.org/project/openapi-python-client/).
...
Copy the generated client files to [cdm_spark_cluster_manager_api_client](../cdm_spark_cluster_manager_api_client)

## Usage
First, create a client:

```python
from cdm_spark_cluster_manager_api_client import Client
...
```python
from cdm_spark_cluster_manager_api_client import AuthenticatedClient
...
```python
from cdm_spark_cluster_manager_api_client.models import MyDataModel
from cdm_spark_cluster_manager_api_client.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `cdm_spark_cluster_manager_api_client.api.default`
